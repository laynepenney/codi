...
\`\`\`
    ...
    // Security fix: bash/shell code blocks no longer auto-execute for security
    // Pattern 4 removed - markdown code blocks should NOT trigger tool calls
    // Only explicit tool call formats (JSON, function-call style) are safe
